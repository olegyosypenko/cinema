    ...
    <c:forEach items="${days}" var="day">
        ...
        <c:choose>
            <c:when test="${dateThat.equals(dateThis)}">
                <a class="chosen" href="${pageContext.request.contextPath}/cinema/free/schedule/<fmt:formatDate value="${day}"  pattern="yyyy-MM-dd"/>"><fmt:formatDate value="${day}"  pattern="EEE"/></a>
            </c:when>
            <c:otherwise>
                <a href="${pageContext.request.contextPath}/cinema/free/schedule/<fmt:formatDate value="${day}"  pattern="yyyy-MM-dd"/>"><fmt:formatDate value="${day}"  pattern="EEE"/></a>
            </c:otherwise>
        </c:choose>
    </c:forEach>
...
<div class="films">
    <c:forEach items="${seances}" var="seance">
        <div class="film">
            ...
            <a href="${pageContext.request.contextPath}/cinema/free/buy-tickets-page/${seance.id}"><fmt:message key="buy.tickets.label" bundle="${language}"/></a>
