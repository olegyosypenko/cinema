...
<div class="form">
    <form id="main-form" class="register-form" method="post" action="${pageContext.request.contextPath}/cinema/guest/register">
        ...
        <p class="message"><fmt:message key="already.registered.question" bundle="${language}"/> <a href="${pageContext.request.contextPath}/cinema/login-page"><fmt:message key="menu.login.label" bundle="${language}"/></a></p>
    </form>
</div>
