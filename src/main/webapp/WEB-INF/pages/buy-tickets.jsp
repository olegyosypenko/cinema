...
<form action="${pageContext.request.contextPath}/servlet/buy-tickets" id="buy-tickets-form">
    <input type="hidden" name="seance-id" value="${seance.id}">
    <input type="hidden" name="user-id" value="${user.id}">
    <button class="button"><fmt:message key="menu.create.seance" bundle="${language}"/></button>
</form>
